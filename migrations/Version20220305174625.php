 ...
 */
final class Version20220305174625 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE couleur_evenement (id INT AUTO_INCREMENT NOT NULL, backgrond_color VARCHAR(255) NOT NULL, border_color VARCHAR(255) NOT NULL, text_color VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE demande_evenement (id INT AUTO_INCREMENT NOT NULL, destination_id INT NOT NULL, utilisateur_id INT NOT NULL, couleur_evenement_id INT DEFAULT NULL, date_demande DATE NOT NULL, statut VARCHAR(255) NOT NULL, description_demande VARCHAR(255) NOT NULL, date_debut_event DATE NOT NULL, date_fin_event DATE NOT NULL, heure_debut_event TIME NOT NULL, heure_fin_event TIME NOT NULL, description_event VARCHAR(255) NOT NULL, capacite INT NOT NULL, libelle_evenement VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_7E0A92CB816C6140 (destination_id), INDEX IDX_7E0A92CBFB88E14F (utilisateur_id), INDEX IDX_7E0A92CB4B39A83E (couleur_evenement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE destination (id INT AUTO_INCREMENT NOT NULL, souscategorie_id INT NOT NULL, delegation_id INT NOT NULL, description VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) NOT NULL, num_tel INT NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_3EC63EAAA27126E0 (souscategorie_id), INDEX IDX_3EC63EAA56CBBCF5 (delegation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
