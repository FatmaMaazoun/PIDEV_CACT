 ...
 */
final class Version20220310004812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE couleur_evenement (id INT AUTO_INCREMENT NOT NULL, backgrond_color VARCHAR(255) NOT NULL, border_color VARCHAR(255) NOT NULL, text_color VARCHAR(255) NOT NULL, libelle_couleur VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cout (id INT AUTO_INCREMENT NOT NULL, coutcategorie_id INT NOT NULL, destination_id INT NOT NULL, prix DOUBLE PRECISION NOT NULL, INDEX IDX_4E7C337A39251E26 (coutcategorie_id), INDEX IDX_4E7C337A816C6140 (destination_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cout_categorie (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE demande_evenement (id INT AUTO_INCREMENT NOT NULL, destination_id INT NOT NULL, utilisateur_id INT NOT NULL, date_demande DATE NOT NULL, statut VARCHAR(255) NOT NULL, description_demande VARCHAR(255) NOT NULL, date_debut_event DATE NOT NULL, date_fin_event DATE NOT NULL, heure_debut_event TIME NOT NULL, heure_fin_event TIME NOT NULL, description_event VARCHAR(255) NOT NULL, capacite INT NOT NULL, libelle_evenement VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_7E0A92CB816C6140 (destination_id), INDEX IDX_7E0A92CBFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE destination (id INT AUTO_INCREMENT NOT NULL, delegation_id INT NOT NULL, souscategorie_id INT NOT NULL, description VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) NOT NULL, num_tel INT NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_3EC63EAA56CBBCF5 (delegation_id), INDEX IDX_3EC63EAAA27126E0 (souscategorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, reservation_id INT NOT NULL, type VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date_rec DATE NOT NULL, etat INT DEFAULT NULL, INDEX IDX_CE606404B83297E7 (reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sous_categorie (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, couleur_evenement_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_52743D7BBCF5E72D (categorie_id), INDEX IDX_52743D7B4B39A83E (couleur_evenement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE demande_evenement ADD CONSTRAINT FK_7E0A92CBFB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_evenement DROP FOREIGN KEY FK_7E0A92CBFB88E14F');
        $this->addSql('ALTER TABLE reservation DROP FOREIGN KEY FK_42C84955FB88E14F');
        $this->addSql('DROP TABLE avis');
        $this->addSql('DROP TABLE billet');
        $this->addSql('DROP TABLE categorie');
        $this->addSql('DROP TABLE couleur_evenement');
